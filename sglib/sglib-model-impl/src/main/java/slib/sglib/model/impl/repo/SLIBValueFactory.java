...
public class SLIBValueFactory extends ValueFactoryBase implements ISLIBValueFactory{
     ...
     * to <tt>null</tt>.
     *
     * @param value The MemValue equivalent of the supplied value, or
     * <tt>null</tt>.
     * @return A previously created MemValue that is equal to <tt>value</tt>, or
     * <tt>null</tt> if no such value exists or if <tt>value</tt> is equal to
     * <tt>null</tt>.
     */
    ...
    /**
     * Gets all URIs that are managed by this value factory. <p> <b>Warning:</b>
     * This method is not synchronized. To iterate over the returned set in a
     * thread-safe way, this method should only be called while synchronizing on
     * this object.
     *
    ...
    /**
     * Gets all bnodes that are managed by this value factory. <p>
    ...
    /**
     * Gets all literals that are managed by this value factory. <p>
     * <b>Warning:</b> This method is not synchronized. To iterate over the
     * returned set in a thread-safe way, this method should only be called
     * while synchronizing on this object.
     *
